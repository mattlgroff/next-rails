...
```bash
npx next-rails migration:generate --name <migration-name>
```
...
```bash
npx next-rails db:rollback
```

## Generate a seed

```bash
npx next-rails seed:generate --name <seed-name>
```
...
```bash
npx next-rails generate model <model-name> [options]
```

## Generate a scaffold

```bash
npx next-rails generate scaffold <model-name> [options]
```
